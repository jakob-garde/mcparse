...
void GetParameters_PowderN(Array<Param> *pars, PowderN *comp) {
    pars->Add( Param { CPT_STRING, "reflections", comp->reflections } );
    pars->Add( Param { CPT_STRING, "geometry", comp->geometry } );
    pars->Add( Param { CPT_FLOAT, "format", &comp->format } );
    ...
    pars->Add( Param { CPT_FLOAT, "pack", &comp->pack } );
    pars->Add( Param { CPT_FLOAT, "Vc", &comp->Vc } );
    pars->Add( Param { CPT_FLOAT, "sigma_abs", &comp->sigma_abs } );
    pars->Add( Param { CPT_FLOAT, "sigma_inc", &comp->sigma_inc } );
    pars->Add( Param { CPT_FLOAT, "delta_d_d", &comp->delta_d_d } );
    pars->Add( Param { CPT_FLOAT, "p_inc", &comp->p_inc } );
    pars->Add( Param { CPT_FLOAT, "p_transmit", &comp->p_transmit } );
    pars->Add( Param { CPT_FLOAT, "DW", &comp->DW } );
    pars->Add( Param { CPT_FLOAT, "nb_atoms", &comp->nb_atoms } );
    pars->Add( Param { CPT_FLOAT, "d_omega", &comp->d_omega } );
    pars->Add( Param { CPT_FLOAT, "d_phi", &comp->d_phi } );
    pars->Add( Param { CPT_FLOAT, "tth_sign", &comp->tth_sign } );
    pars->Add( Param { CPT_FLOAT, "p_interact", &comp->p_interact } );
    pars->Add( Param { CPT_FLOAT, "concentric", &comp->concentric } );
    pars->Add( Param { CPT_FLOAT, "density", &comp->density } );
    pars->Add( Param { CPT_FLOAT, "weight", &comp->weight } );
